...
@section('content')
    ...
    <section class="relative bg-[#383838] text-white">
        <div class="container mx-auto px-6 py-20 sm:py-24 text-center max-w-4xl">
            ...
            <div class="mt-8 flex flex-col sm:flex-row justify-center gap-3">
                ...
                <a href="#" class="px-6 py-3 border border-[#5c5c5c] text-white hover:bg-[#5c5c5c]/30 font-medium rounded-lg transition-colors duration-300">
                    Konsultasi Gratis
                </a>
            </div>
        </div>
    ...
    <section id="services" class="py-16 bg-[#383838]">
        <div class="container mx-auto px-6 max-w-4xl">
            <div class="text-center mb-12">
                ...
                <p class="mt-2 text-[#aeaeae]">Berbagai layanan unggulan dengan kualitas terbaik.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-[#5c5c5c] p-6 rounded-lg hover:bg-[#6c6c6c] transition-colors duration-300">
                    ...
                    <p class="text-[#aeaeae] text-sm text-center mb-4">
                        Desain grafis kreatif untuk branding dan kebutuhan visual.
                    </p>
                ...
                <div class="bg-[#5c5c5c] p-6 rounded-lg hover:bg-[#6c6c6c] transition-colors duration-300">
                    ...
                    <p class="text-[#aeaeae] text-sm text-center mb-4">
                        Desain kaos sesuai keinginan dengan bahan premium.
                    </p>
                    <ul class="space-y-2 text-sm text-[#aeaeae]">
                        <li class="flex items-center">
                            <svg class="w-4 h-4 text-white mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-[#5c5c5c] p-6 rounded-lg hover:bg-[#6c6c6c] transition-colors duration-300">
                    ...
                    <p class="text-[#aeaeae] text-sm text-center mb-4">
                        Bantuan penyelesaian tugas kuliah terjamin.
                    </p>
                    <ul class="space-y-2 text-sm text-[#aeaeae]">
                        <li class="flex items-center">
                            <svg class="w-4 h-4 text-white mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Compact CTA Section -->
    <section class="py-12 bg-[#383838]">
        <div class="container mx-auto px-6 text-center max-w-4xl">
            <h2 class="text-2xl sm:text-3xl font-bold mb-4 text-white">Siap Mewujudkan Ide Anda?</h2>
            <p class="text-[#aeaeae] mb-6">Hubungi kami untuk konsultasi gratis.</p>
            <a href="#" class="inline-block px-6 py-2.5 bg-[#5c5c5c] hover:bg-[#909090] text-white font-medium rounded-lg transition-colors duration-300">
                Hubungi Kami
            </a>
        </div>
    </section>
