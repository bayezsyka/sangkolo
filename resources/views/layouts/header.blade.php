  ...
  <nav
    ...
    <div id="mobile-menu" x-cloak x-show="open" x-transition.origin.top
      ...
      <div class="px-3 sm:px-4 py-3 space-y-1">
        <a href="#modal-pengembangan" class="block px-3 py-2 rounded-md text-sm font-medium focus:outline-none focus:ring-2 focus:ring-neutral-500/40 hover:opacity-80">Kaos Custom</a>
